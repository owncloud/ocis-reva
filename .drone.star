config = {
  'apiTests': {
    'coreBranch': 'master',
    'coreCommit': '8c9cd7bd258b9c9b952eb472e4131350e4106f94',
    'numberOfParts': 2
  }
}
    ...
    'steps':
      ...
      cloneCoreRepos(coreBranch, coreCommit) + [
      {
        ...
        'environment' : {
          ...
          'REVA_LDAP_HOSTNAME':'ldap',
          'TEST_OCIS':'true',
          'BEHAT_FILTER_TAGS': '@toImplementOnOCIS&&~comments-app-required&&~@federation-app-required&&~@notifications-app-required&&~systemtags-app-required&&~@provisioning_api-app-required&&~@preview-extension-required&&~@local_storage',
